...
func RunValidateResponses_BodyRegexpPlaceholder(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_regexp_simple_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_regexp_simple_no_match.hresp",
			expectedErrCount: 1,
			expectedErrTexts: []string{
		...
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_regexp_multiple_match.hresp",
			expectedErrCount: 0,
		},
		// {
		...
		// 	expectedFilePath: "test/data/http_response_files/validator_body_regexp_special_chars.hresp",
		// 	expectedErrCount: 0,
		// },
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_regexp_invalid_pattern.hresp",
			expectedErrCount: 1,
...
func RunValidateResponses_BodyAnyGuidPlaceholder(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anyguid_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anyguid_no_match.hresp",
			expectedErrCount: 1,
		...
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anyguid_larger_text.hresp",
			expectedErrCount: 0,
		},
	}
...
func RunValidateResponses_BodyAnyTimestampPlaceholder(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anytimestamp_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anytimestamp_no_match.hresp",
			expectedErrCount: 1,
			expectedErrTexts: []string{"body mismatch (regexp/placeholder evaluation failed)"},
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anytimestamp_float.hresp",
			expectedErrCount: 1,
			expectedErrTexts: []string{"body mismatch (regexp/placeholder evaluation failed)"},
		},
	}
...
func RunValidateResponses_BodyAnyDatetimePlaceholder(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anydatetime_rfc1123_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anydatetime_iso8601_match.hresp",
			expectedErrCount: 0,
		},
		{
		...
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anydatetime_custom_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anydatetime_format_mismatch.hresp",
			expectedErrCount: 1,
			expectedErrTexts: []string{"body mismatch (regexp/placeholder evaluation failed)"},
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anydatetime_invalid_keyword.hresp",
			expectedErrCount: 1,
		...
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anydatetime_missing_format.hresp",
			expectedErrCount: 1,
			expectedErrTexts: []string{"body mismatch (regexp/placeholder evaluation failed)", "(\\z.\\A)"},
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_anydatetime_custom_empty_format.hresp",
			expectedErrCount: 1,
			expectedErrTexts: []string{"body mismatch (regexp/placeholder evaluation failed)", "(\\z.\\A)"},
		},
	}
...
func RunValidateResponses_BodyAnyPlaceholder(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_any_simple_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_any_special_chars_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_any_empty_segment_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_any_multiline_match.hresp",
			expectedErrCount: 0,
		},
		{
			...
			expectedFilePath: "test/data/http_response_files/validator_body_any_multiple_placeholders_match.hresp",
			expectedErrCount: 0,
		},
		{
