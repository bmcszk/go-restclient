...
## Previous Learnings (Historical Detail)

The entries below provide historical context and detailed accounts of issues encountered and resolved prior to the consolidation on 2025-06-11. While the core lessons are now in the rule files, these entries can offer deeper insight into specific scenarios.
